...
- **Battleship:** 365 cells across 9 domains (28 🔴 P0, 172 🟡 P1, 165 ⚪ P3)
...
- **Latest batch:** Perpetual gap-closing loop — A02 fixed (dup-loop + trade_count persist), A04 snapshot precision, 7 claims verified/resolved. P0: 35→28.
