...
- **Battleship:** 365 cells across 9 domains (1 🔴 P0, 81 🟡 P1, 183 ⚪ P3)
...
- **Latest batch:** G11 input validation (NaN/Inf/corrupt price checks on market_feed.json), G10 CORS stale. P1: 83→81.
