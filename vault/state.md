...
- **Battleship:** 365 cells across 9 domains (1 🔴 P0, 127 🟡 P1, 228 ⚪ P3)
- **Rooms:** 16 configured. market_type set per room. SIGMA_NORMALIZER fixed (0.001→0.15). 98% agent voting. 32 features (OB, CVD, 7 derived, time, options). Warm-start from elite genomes on restart.
