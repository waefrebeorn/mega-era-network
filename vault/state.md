...
- **Battleship:** 365 cells across 9 domains (1 🔴 P0, 128 🟡 P1, 227 ⚪ P3)
- **Rooms:** 16 configured. market_type set per room. SIGMA_NORMALIZER fixed (0.001→0.15). 98% agent voting. OB + CVD + 7 derived + time features wired. N_FEATURES=29. Warm-start from elite genomes on restart.
